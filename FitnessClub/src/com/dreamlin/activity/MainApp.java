...
public class MainApp extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		View view1 = mLi.inflate(R.layout.info, null);
		View view2 = mLi.inflate(R.layout.students, null);
		View view3 = mLi.inflate(R.layout.person, null);
		View view4 = mLi.inflate(R.layout.stores, null);
	...
	public void student2(View v) {
		Intent it = new Intent(MainApp.this, Students2.class);
		startActivity(it);
	}

	public void coach(View v) {
		Intent it = new Intent(MainApp.this, Coach.class);
		startActivity(it);
	}
	public void stores_32(View v){
		Intent it = new Intent(MainApp.this, Stores_32.class);
		startActivity(it);
	}
}
