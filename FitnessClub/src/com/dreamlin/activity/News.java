...
public class News extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		View view1 = mLi.inflate(R.layout.new1, null);
		View view2 = mLi.inflate(R.layout.new2, null);
		View view3 = mLi.inflate(R.layout.new3, null);
		View view4 = mLi.inflate(R.layout.new4, null);
		View view5 = mLi.inflate(R.layout.new5, null);
		View view6 = mLi.inflate(R.layout.new6, null);
	...
	public void startbutton(View v) {
		...
		intent.setClass(News.this, NewsDoor.class);
